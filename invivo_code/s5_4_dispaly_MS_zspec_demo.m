...
load(".\preprocessedData_multi_batch\QUASS_preproc_ms_"+MSID+".mat",...
                'roi_csf','roi_gm','roi_wm','CEST_data','offs_CEST','T1map','WASABI_data');
load(".\MSlesionROI_8ms_20250702\roi_lesion_"+MSID+".mat",'roi_lesion','T1w','M0');
...
nexttile(3)
imshow(M0,[]);axis equal;axis off;axis tight;
title('CEST@M0','FontName', 'Times New Roman','FontSize',13);
...
clim([0,4]);colorbar;title('T1map [s]','FontName', 'Times New Roman','FontSize',13)
...
% exportgraphics(Fig, "fig_zspecDemo_MS_"+MSID+".png", 'BackgroundColor', 'white', 'Resolution', 600);
