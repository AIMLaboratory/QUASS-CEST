...
datafolder = "..\invivo_code\Outprocess_multi_batch\QUASS_preproc_";
dateIDList = [
    "ms_20250522";
    "hc_20250228"];
...
for idx = 1:length(dateIDList)
    dataID = dateIDList(idx);
    ...
    MPLFresultComp_2D(CESTfit_data(1:3),colranArr,OutputDir+"\figs_B1_0.5uT_maps_"+dataID+".png");
    MPLFHistComp_2D(CESTfit_data(1:3), legList,roi,histrange,OutputDir+"\figs_B1_0.5uT_hist_"+dataID+".png");

    % B1 = 1.0uT
    histrange = [0.01,0.33];
    colranArr = [[0,0.08];[0,0.07];[0,0.12];[0,0.35]]; % amide, guan, rNOE, MT
    MPLFresultComp_2D(CESTfit_data(4:6),colranArr,OutputDir+"\figs_B1_1.0uT_maps_"+dataID+".png");
    MPLFHistComp_2D(CESTfit_data(4:6), legList,roi,histrange,OutputDir+"\figs_B1_1.0uT_hist_"+dataID+".png");
